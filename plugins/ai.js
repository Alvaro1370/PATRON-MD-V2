...
smd(
  ...
  async (m) => {
    try {
      ...
      await m.send("PATRON is thinking 🤔");
...
smd(
  ...
  async (m) => {
    try {
      ...
      // Send a loading message
      await m.send("PATRON-MD is thinking 🤔");
    ...
    async (_0x2acf30) => {
      try {
        if (
          ...
          if (
            _0x2acf30.reply_text.includes("PATRON-MD• ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") &&
            _0x2dfb59[0].includes("PATRON-MD • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") &&
            ...
            try {
              if (_0x2ecd2a) {
                ...
                if (_0x13a11c.toLowerCase().startsWith("reply")) {
                  ...
                  let _0x3f6b59 =
                    "*PATRON-MD • ʏᴏᴜʀ ᴀɴᴏɴʏ-ᴍsɢ ʀᴇᴘʟʏ*\n\n*_From @" +
